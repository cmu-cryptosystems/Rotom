"""ResNet20 definition mirrored from DaCapo's poly.models.ResNet.

This is a plain PyTorch model (SiLU activations) that can be trained/evaluated
on CIFAR-10 in the e2e benchmark harness.
"""
