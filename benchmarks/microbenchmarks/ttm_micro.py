...
def ttm_micro(n):
    ...
    tensor_layout = Layout(
        term,
        [],
        [Dim.parse("[1:64:1]"), Dim.parse("[2]"), Dim.parse("[0:64:1]")],
        {},
        n,
        True,
    )
    ...
    rolled_m_layout = Layout(
        term,
        [Roll(Dim.parse("[1:64:1]"), Dim.parse("[64]"))],
        [
            Dim.parse("[1:64:1]"),
            Dim.parse("[32]"),
            Dim.parse("[64]"),
    ...
    m = Kernel(
        KernelOp.ROT_ROLL,
        [Roll(Dim.parse("[1:64:1]"), Dim.parse("[64]")), m],
    ...
    matmul_layout = Layout(
        term,
        [Roll(Dim.parse("[2:64:1]"), Dim.parse("[0:64:1]"))],
        [
            Dim.parse("[2:64:1]"),
            Dim.parse("[1:32:2]"),
            Dim.parse("[0:64:1]"),
