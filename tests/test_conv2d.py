...
class TestConvolution2D:
    ...
    def _create_convolution_computation(self, input_size, input_channel, f_out, f_in, f_h, f_w, stride, padding):
    ...
    def test_conv2d_4x4_filter_2x2(self):
        ...
        # Generate test case
        tensor_ir = self._create_convolution_computation(dim_size, 1, 1, 1, f_size, f_size, 1, padding)
    ...
    def test_conv2d_4x4_3channels_filter_3x3(self):
        ...
        # Generate test case
        tensor_ir = self._create_convolution_computation(dim_size, input_channels, 1, 1, f_size, f_size, 1, padding)
        self._run_test_case(tensor_ir, inputs, args)
