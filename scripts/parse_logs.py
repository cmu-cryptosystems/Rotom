...
if __name__ == "__main__":
    ...
    print()
    if args.sys == "rotom":
        filtered_df = df[df["fn"].str.contains(args.fn)].sort_values("run")[["fn", "run", "runtime", "compile time", "data size", "depth"]]
    else:
        filtered_df = df[df["fn"].str.contains(args.fn)].sort_values("run")[["fn", "run", "runtime", "data size", "depth"]]
