...
from assignment.gen.gen_conv2d import gen_conv2d, gen_conv2d_toeplitz
...
class LayoutAssignment:
    ...
    def __init__(self, comp, args=None):
        ...
        self.toeplitz = (
            args.toeplitz if args and hasattr(args, "toeplitz") else False
        )
    ...
    def generate_candidate_kernels(self, term):
        ...
        match term.op:
            ...
            case TensorOp.CONV2D:
                ...
                if self.toeplitz:
                    kernels = gen_conv2d_toeplitz(term, cs_kernels[0], cs_shapes)
                else:
