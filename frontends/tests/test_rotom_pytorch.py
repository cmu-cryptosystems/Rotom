...
class TestTensorShapeOperations:
    ...
    def test_mean_operation(self):
        ...
        with pytest.raises(NotImplementedError, match="Mean operation not yet implemented"):
            self.a.mean(0)
    ...
    def test_squeeze_unsqueeze_operations(self):
        ...
        with pytest.raises(NotImplementedError, match="Squeeze operation not yet implemented"):
            b.squeeze()
        
        # Unsqueeze should raise NotImplementedError
        with pytest.raises(NotImplementedError, match="Unsqueeze operation not yet implemented"):
            b.unsqueeze(0)
...
class TestNeuralNetworkFunctions:
    ...
    def test_relu_function(self):
        ...
        with pytest.raises(NotImplementedError, match="ReLU operation not yet implemented"):
            torch.relu(a)
    ...
    def test_sigmoid_function(self):
        ...
        with pytest.raises(NotImplementedError, match="Sigmoid operation not yet implemented"):
            torch.sigmoid(a)
...
class TestTensorProperties:
    ...
    def test_clone_detach(self):
        ...
        with pytest.raises(NotImplementedError, match="Detach operation not yet implemented"):
            a.detach()
...
class TestErrorHandling:
    ...
    def test_empty_tensor_list(self):
        ...
        with pytest.raises(NotImplementedError, match="Concatenation operation not yet implemented"):
            torch.cat([])
        
        with pytest.raises(NotImplementedError, match="Stack operation not yet implemented"):
            torch.stack([])
