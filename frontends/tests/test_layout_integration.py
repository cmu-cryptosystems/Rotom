...
class TestLayoutIntegration:
    ...
    def test_matrix_multiplication_with_different_layouts(self):
        ...
        b = TensorTerm.Tensor("b", [4, 4], True, layout="[1:4:1][0:4:1]")  # Column-major
    ...
    def test_neural_network_layer_simulation(self):
        ...
        input_tensor = TensorTerm.Tensor("input", [32, 128], True, layout="[0:32:1][1:128:1]")
        
        # Weight matrix (input_features, output_features)
        weights = TensorTerm.Tensor("weights", [128, 64], False, layout="[0:128:1][1:64:1]")
    ...
    def test_convolutional_layer_with_layout(self):
        ...
        input_tensor = TensorTerm.Tensor("input", [3, 32, 32], True, 
                                       layout="[0:3:1][1:32:1][2:32:1]")
        
        # Filter tensor (output_channels, input_channels, filter_h, filter_w)
        filters = TensorTerm.Tensor("filters", [64, 3, 3, 3], False,
                                  layout="[0:64:1][1:3:1][2:3:1][3:3:1]")
        
        # Convolution with specific output layout
        conv_output = TensorTerm.conv2d(input_tensor, filters, 1, "same",
                                      layout="[0:64:1][1:32:1][2:32:1]")
    ...
    def test_attention_mechanism_simulation(self):
        ...
        query = TensorTerm.Tensor("query", [8, 16, 64], True, layout="[0:8:1][1:16:1][2:64:1]")
        key = TensorTerm.Tensor("key", [8, 16, 64], True, layout="[0:8:1][1:16:1][2:64:1]")
        value = TensorTerm.Tensor("value", [8, 16, 64], True, layout="[0:8:1][1:16:1][2:64:1]")
        
        # Attention scores: query @ key^T
        attention_scores = query.matmul(key.transpose(layout="[0:8:1][2:64:1][1:16:1]"),
                                      layout="[0:8:1][1:16:1][1:16:1]")
        
        # Apply attention to values
        attended_values = attention_scores.matmul(value, layout="[0:8:1][1:16:1][2:64:1]")
    ...
    def test_multi_head_attention_layouts(self):
        ...
        input_tensor = TensorTerm.Tensor("input", [8, 16, 128], True,
                                       layout="[0:8:1][1:16:1][2:128:1]")
