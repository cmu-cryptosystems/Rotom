...
class TensorTerm:
    ...
    def Tensor(name, shape, secret):
        ...
        Example:
            ...
            >>> b = TensorTerm.Tensor("b", [64], False)     # 64-element plaintext vector
        """
        return TensorTerm(TensorOp.TENSOR, [name, shape, secret])
    ...
    def const(value):
        ...
        """
        return TensorTerm(TensorOp.CONST, [value])
    ...
    def __add__(self, other):
        ...
        """
        return TensorTerm(TensorOp.ADD, [self, other])
    ...
    def __sub__(self, other):
        ...
        """
        return TensorTerm(TensorOp.SUB, [self, other])
    ...
    def __mul__(self, other):
        ...
        """
        return TensorTerm(TensorOp.MUL, [self, other])
    ...
    def sum(self, dim_idx):
        ...
        """
        return TensorTerm(TensorOp.SUM, [self, dim_idx])
    ...
    def product(self, dim_idx):
        ...
        """
        return TensorTerm(TensorOp.PRODUCT, [self, dim_idx])
    ...
    def matmul(self, other):
        ...
        """
        return TensorTerm(TensorOp.MATMUL, [self, other])
    ...
    def block_matmul(self, other):
        ...
        """
        return TensorTerm(TensorOp.BLOCK_MATMUL, [self, other])
    ...
    def Poly(self):
        ...
        """
        return TensorTerm(TensorOp.POLY, [self])
    ...
    def reshape(self, dim, shape):
        ...
        """
        return TensorTerm(TensorOp.RESHAPE, [self, dim, shape])
    ...
    def permute(self, dim_map):
        ...
        """
        return TensorTerm(TensorOp.PERMUTE, [self, dim_map])
    ...
    def __getitem__(self, item):
        ...
        """
        return TensorTerm(TensorOp.INDEX, [self, item])
    ...
    def conv2d(a, b, stride, padding):
        ...
        """
        return TensorTerm(TensorOp.CONV2D, [a, b, stride, padding])
